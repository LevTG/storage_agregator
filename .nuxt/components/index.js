...
export { default as SharedTypeSave } from '../../components/shared/TypeSave.vue'
...
export const LazySharedTypeSave = import('../../components/shared/TypeSave.vue' /* webpackChunkName: "components/shared-type-save" */).then(c => wrapFunctional(c.default || c))
